...
WCHAR szAboutboxText[MAX_LOADTEXT];
                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDS_ABOUTBOX_TEXT, szAboutboxText, MAX_LOADTEXT);
...
INT_PTR CALLBACK About(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    {
    case WM_INITDIALOG:
        SetDlgItemText(hDlg, IDC_ABOUTBOXTEXT, szAboutboxText);
        return (INT_PTR)TRUE;
